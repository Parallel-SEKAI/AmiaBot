...
features:
  ...
  - title: 实用工具
    details: 提供B站视频解析,GitHub链接解析,网易云音乐功能等实用工具
  - title: 高度可扩展
    details: 基于模块化设计,支持轻松扩展新功能
  - title: Project Sekai 主题
    details: 以 Project Sekai 的暁山瑞希为主题,包含相关贴纸和互动内容
  - title: 支持 OneBot 协议
    details: 基于 OneBot(NapCat) 接口,兼容多种QQ机器人框架
---
...
2. 查看 [使用指南](/guide/) 了解如何使用各种功能
3. 根据 [部署指南](/deploy/) 自行部署 AmiaBot
4. 参考 [二次开发](/development/) 指南扩展新功能
